...
instance Contravariant Predicate where
  (>$<) ::
    ...
    -> Predicate a
    -> Predicate b
  ba >$< pa = Predicate $ runPredicate pa . ba
...
instance Contravariant Comparison where
  (>$<) ::
    ...
    -> Comparison a
    -> Comparison b
  f >$< ca = Comparison $ \x y -> runComparison ca (f x) (f y)
...
instance Contravariant (SwappedArrow t) where
  (>$<) ::
    ...
    -> SwappedArrow x a
    -> SwappedArrow x b
  -- f >$< ax = SwappedArrow $ \b -> runSwappedArrow ax (runSwappedArrow (SwappedArrow f) b)
  f >$< ax = SwappedArrow $ runSwappedArrow ax . runSwappedArrow (SwappedArrow f)
